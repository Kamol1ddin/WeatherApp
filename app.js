...
function changePhoto(data) {
  ...
  if (data.weather[0].description === "few clouds") {
    icons.setAttribute('src', 'Icon/few clouds.png')
    getPhoto(
  ...
  if (data.weather[0].description === "moderate rain") {
    icons.setAttribute('src', 'Icon/moderate rain.png')
    getPhoto(
      "https://images.pexels.com/photos/2609106/pexels-photo-2609106.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    );
  }
  ...
  if (data.weather[0].description === "overcast clouds") {
    icons.setAttribute('src', 'Icon/overcast clouds.png')
    getPhoto(
  ...
  if (data.weather[0].description === "broken clouds") {
    icons.setAttribute('src', 'Icon/broken clouds.png')
    getPhoto(
      "https://wallpaperbat.com/img/356993-clouds-picture.jpg"
    );
  }

  if (data.weather[0].description === "scattered clouds") {
    icons.setAttribute('src', 'Icon/scattered clouds.png')
    getPhoto(
      "https://images.pexels.com/photos/7292745/pexels-photo-7292745.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    );
  }
  ...
  if (data.weather[0].description === "light snow") {
    icons.setAttribute('src', 'Icon/light snow.png')
    getPhoto(
  ...
  if (data.weather[0].description === "snow") {
    icons.setAttribute('src', 'Icon/snow.png')
    getPhoto(
